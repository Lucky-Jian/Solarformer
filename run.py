...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,  default='Solarformer',
                        help='model name, options: [Autoformer, Transformer, TimesNet,Solarformer]')

    # data loader
    parser.add_argument('--data', type=str,  default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Sanyo.csv', help='data file')
