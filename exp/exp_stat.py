...
class Exp_Main(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        mae, mse, rmse, mape, mspe, rse, corr, mspe, smape, r = metric(preds, trues)
        corr = []
        print('mse:{}, mae:{}, rmse:{}, smape:{},r:{}'.format(mse, mae, rmse, smape, r))
        f = open("result.txt", 'a')
        f.write(setting + "  \n")
        f.write('mse:{}, mae:{}, rmse:{}, smape:{},r:{}'.format(mse, mae, rmse, smape, r))
        f.write('\n')
        f.write('\n')
        f.close()

        np.save(folder_path + 'metrics.npy', np.array([mse, mae, rmse, smape, r]))
